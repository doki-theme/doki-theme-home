...
export const changes: Change[] = [
  ...
  {
    version: '88.5-1.13.0',
    changes: `- Added initial 2024.1 build support.`,
  },
  {
    version: '88.5-1.11.0',
    changes: `- Added initial 2023.2 build support.`,
    released: true,
  },
  {
    version: '88.5-1.10.0',
  ...
  {
    version: '88.5-1.9.5',
    changes: `- Made Non-Functional & Non-User-facing code cleanup updates.`,
  },
  {
    version: '88.4-1.9.4',
